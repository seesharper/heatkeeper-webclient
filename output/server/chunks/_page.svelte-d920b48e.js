import { c as create_ssr_component, v as validate_component, h as each, f as escape, s as setContext, a as add_attribute, b as spread, d as escape_object, e as escape_attribute_value, g as getContext } from './ssr-fb83eaae.js';
import { H as Heading, B as Button } from './Heading-808c317f.js';
import { a as twJoin, t as twMerge, i as is_void } from './tw-merge-63ee20bd.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Heading, "Heading").$$render($$result, { tag: "h3", class: "text-center" }, {}, {
    ...
    $$result,
    {
      divClass: "relative overflow-x-auto rounded-md mt-5",
      hoverable: true
    },
    {},
    {
            ...
            return `${each(data.result, (item) => {
              return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
                default: () => {
                  ...
                  })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "text-end" }, {}, {
                    default: () => {
                      return `${validate_component(Button, "Button").$$render($$result, { size: "sm", href: "locations/" + item.id }, {}, {
                        default: () => {
                          return `Edit`;
                        }
                      })} `;
...
//# sourceMappingURL=_page.svelte-d920b48e.js.map
