import { c as create_ssr_component, v as validate_component, a as add_attribute, b as spread, e as escape_attribute_value, d as escape_object, g as getContext, s as setContext, f as escape } from './ssr-fb83eaae.js';
...
import { w as writable } from './index-b3363d5c.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="p-8">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-am4pxf">HeatKeeper</span>`;
        }
        ...
        default: () => {
          ...
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/docs/components/navbar" }, {}, {
            default: () => {
              return `Navbar`;
            }
  ...
  })}</div> <div class="m-10">${slots.default ? slots.default({}) : ``}</div>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-b882bcaa.js.map
